...
MINUNIT_ADD(LPC812M101CppSpiSyncRxTx, LPC812M101CppSetupSpiSync, LPC812M101Teardown) {
  ...
  MINUNIT_CHECK((dutRegisters->STAT & STAT::RESERVED_MASK) == 0x00000102);
  MINUNIT_CHECK(dutRegisters->DIV == 29);
