...
#include <string.h>
#include <stdint.h>
#include <libmcu/bitmap/bitblit2dsmall.hpp>
...
MINUNIT_ADD(testBitBlit2DSameBits, NULL, NULL) {
  ...
  MINUNIT_CHECK(dest[0] == 0xcf);
  MINUNIT_CHECK(dest[1] == 0x22);
  MINUNIT_CHECK(dest[2] == 0xcf);
  MINUNIT_CHECK(dest[3] == 0x22);
  MINUNIT_CHECK(dest[4] == 0x22);
  MINUNIT_CHECK(dest[5] == 0x22);
  MINUNIT_CHECK(dest[6] == 0x22);
  MINUNIT_CHECK(dest[7] == 0x22);
  ...
  MINUNIT_CHECK(dest[0] == 0x5c);
  MINUNIT_CHECK(dest[1] == 0x5c);
  MINUNIT_CHECK(dest[2] == 0x29);
  MINUNIT_CHECK(dest[3] == 0x59);
  MINUNIT_CHECK(dest[4] == 0x29);
  MINUNIT_CHECK(dest[5] == 0x59);
  MINUNIT_CHECK(dest[6] == 0x5c);
  MINUNIT_CHECK(dest[7] == 0x5c);
  ...
  MINUNIT_CHECK(dest[0] == 0x00);
  MINUNIT_CHECK(dest[1] == 0x00);
  MINUNIT_CHECK(dest[2] == 0x3C);
  MINUNIT_CHECK(dest[3] == 0x3C);
  MINUNIT_CHECK(dest[4] == 0x3C);
  MINUNIT_CHECK(dest[5] == 0x3C);
  MINUNIT_CHECK(dest[6] == 0x00);
  MINUNIT_CHECK(dest[7] == 0x00);
  ...
  MINUNIT_CHECK(dest[0] == 0x31);
  MINUNIT_CHECK(dest[1] == 0x31);
  MINUNIT_CHECK(dest[2] == 0x31);
  MINUNIT_CHECK(dest[3] == 0x31);
  MINUNIT_CHECK(dest[4] == 0x21);
  MINUNIT_CHECK(dest[5] == 0x3C);
  MINUNIT_CHECK(dest[6] == 0x21);
  MINUNIT_CHECK(dest[7] == 0x3C);
  ...
  MINUNIT_CHECK(dest[0] == 0xCC);
  MINUNIT_CHECK(dest[1] == 0xCC);
  MINUNIT_CHECK(dest[2] == 0xCC);
  MINUNIT_CHECK(dest[3] == 0xAA);
  MINUNIT_CHECK(dest[4] == 0xCC);
  MINUNIT_CHECK(dest[5] == 0xAA);
  MINUNIT_CHECK(dest[6] == 0xCC);
  MINUNIT_CHECK(dest[7] == 0xCC);
  ...
  MINUNIT_CHECK(dest[0] == 0xAA);
  MINUNIT_CHECK(dest[1] == 0xAA);
  MINUNIT_CHECK(dest[2] == 0xAA);
  MINUNIT_CHECK(dest[3] == 0x4A);
  MINUNIT_CHECK(dest[4] == 0xAA);
  MINUNIT_CHECK(dest[5] == 0x4A);
  MINUNIT_CHECK(dest[6] == 0xAA);
  MINUNIT_CHECK(dest[7] == 0xAA);
  ...
  MINUNIT_CHECK(dest[0] == 0x2C);
  MINUNIT_CHECK(dest[1] == 0x2C);
  MINUNIT_CHECK(dest[2] == 0x2C);
  MINUNIT_CHECK(dest[3] == 0x2C);
  MINUNIT_CHECK(dest[4] == 0x2C);
  MINUNIT_CHECK(dest[5] == 0x2C);
  MINUNIT_CHECK(dest[6] == 0x2C);
  MINUNIT_CHECK(dest[7] == 0xFC);
...
MINUNIT_ADD(testBitBlit2DBiggerBits, NULL, NULL) {
  ...
  memset(src, 0xcf, sizeof(src));
  libmcu::bitmap::bitblit2dsmall(dest, 16u, 4u, 0u, 0u, src, 8u, 2u, libmcu::bitmap::bitblitOperation::OP_MOV);
  MINUNIT_CHECK(dest[0] == 0x22cf);
  MINUNIT_CHECK(dest[1] == 0x22cf);
  MINUNIT_CHECK(dest[2] == 0x2222);
  MINUNIT_CHECK(dest[3] == 0x2222);

  // destination aligned, destination element crossing
  memset(dest, 0x5c, sizeof(dest));
  memset(src, 0x29, sizeof(src));
  libmcu::bitmap::bitblit2dsmall(dest, 32u, 2u, 0u, 1u, src, 20u, 1u, libmcu::bitmap::bitblitOperation::OP_MOV);
  MINUNIT_CHECK(dest[0] == 0x5c5c);
  MINUNIT_CHECK(dest[1] == 0x5c5c);
  MINUNIT_CHECK(dest[2] == 0x2929);
  MINUNIT_CHECK(dest[3] == 0x5c59);
}
...
MINUNIT_ADD(testBitBlit2DOperations, NULL, NULL) {
  ...
  MINUNIT_CHECK(dest[0] == 0x02);
  MINUNIT_CHECK(dest[1] == 0x22);
  MINUNIT_CHECK(dest[2] == 0x02);
  MINUNIT_CHECK(dest[3] == 0x22);
  MINUNIT_CHECK(dest[4] == 0x22);
  MINUNIT_CHECK(dest[5] == 0x22);
  MINUNIT_CHECK(dest[6] == 0x22);
  ...
  memset(src, 0x0F, sizeof(src));
  libmcu::bitmap::bitblit2dsmall(dest, 16u, 4u, 0u, 0u, src, 8u, 2u, libmcu::bitmap::bitblitOperation::OP_MOV);
  MINUNIT_CHECK(dest[0] == 0x0F);
  MINUNIT_CHECK(dest[1] == 0x22);
  MINUNIT_CHECK(dest[2] == 0x0F);
  MINUNIT_CHECK(dest[3] == 0x22);
  MINUNIT_CHECK(dest[4] == 0x22);
  MINUNIT_CHECK(dest[5] == 0x22);
  MINUNIT_CHECK(dest[6] == 0x22);
  ...
  MINUNIT_CHECK(dest[0] == 0xF0);
  MINUNIT_CHECK(dest[1] == 0x22);
  MINUNIT_CHECK(dest[2] == 0xF0);
  MINUNIT_CHECK(dest[3] == 0x22);
  MINUNIT_CHECK(dest[4] == 0x22);
  MINUNIT_CHECK(dest[5] == 0x22);
  MINUNIT_CHECK(dest[6] == 0x22);
  ...
  MINUNIT_CHECK(dest[0] == 0x2F);
  MINUNIT_CHECK(dest[1] == 0x22);
  MINUNIT_CHECK(dest[2] == 0x2F);
  MINUNIT_CHECK(dest[3] == 0x22);
  MINUNIT_CHECK(dest[4] == 0x22);
  MINUNIT_CHECK(dest[5] == 0x22);
  MINUNIT_CHECK(dest[6] == 0x22);
  ...
  MINUNIT_CHECK(dest[0] == 0x2D);
  MINUNIT_CHECK(dest[1] == 0x22);
  MINUNIT_CHECK(dest[2] == 0x2D);
  MINUNIT_CHECK(dest[3] == 0x22);
  MINUNIT_CHECK(dest[4] == 0x22);
  MINUNIT_CHECK(dest[5] == 0x22);
  MINUNIT_CHECK(dest[6] == 0x22);
