...
MINUNIT_ADD(RP2040pads, RP2040SetupPads, Rp2040Teardown) {
  ...
  MINUNIT_CHECK(dutRegisters->GPIO[0] == 0x00'00'00'50u);
  MINUNIT_CHECK(dutRegisters->GPIO[1] == 0x00'00'00'58u);
  libmcu::Delay(100);  // wait time until everything propagates
  // check INFROMPAD flag in GPIO status
  MINUNIT_CHECK((gpioRegisters->GPIO[0].STATUS & libmcuhw::gpio_bank0::STATUS::RESERVED_MASK) == 0x05'0A'00'00u);
  MINUNIT_CHECK((gpioRegisters->GPIO[1].STATUS & libmcuhw::gpio_bank0::STATUS::RESERVED_MASK) == 0x05'0A'00'00u);
  ...
  MINUNIT_CHECK(dutRegisters->GPIO[1] == 0x00'00'00'50u);
  libmcu::Delay(100);
  MINUNIT_CHECK((gpioRegisters->GPIO[0].STATUS & libmcuhw::gpio_bank0::STATUS::RESERVED_MASK) == 0x00'00'00'00u);
  MINUNIT_CHECK((gpioRegisters->GPIO[1].STATUS & libmcuhw::gpio_bank0::STATUS::RESERVED_MASK) == 0x00'00'00'00u);
}
...
MINUNIT_ADD(RP2040PadsPullModes, RP2040SetupPads, Rp2040Teardown) {
  ...
  MINUNIT_CHECK(dutRegisters->GPIO[0] == 0x00'00'00'58u);
  MINUNIT_CHECK(dutRegisters->GPIO[1] == 0x00'00'00'54u);
}