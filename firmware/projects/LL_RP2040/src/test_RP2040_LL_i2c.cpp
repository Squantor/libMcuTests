...
MINUNIT_ADD(RP2040LLI2cWrite, RP2040LLSetupI2C, Rp2040Teardown) {
  ...
  minUnitCheck(400000 == i2c_polled_peripheral.setup(libmcull::i2c::I2cModes::kFast, 400000));
  minUnitCheck(i2c_polled_peripheral.write(dummyAddress, transmitData, 0x10000u) == libmcu::Results::kInvalidAddress);
  minUnitCheck(i2c0Registers->IC_STATUS == 0x06);
  minUnitCheck(i2c_polled_peripheral.write(expanderAddress, transmitData, 0x10000u) == libmcu::Results::kDone);
  minUnitCheck(i2c0Registers->IC_STATUS == 0x06);
}
...
MINUNIT_ADD(RP2040LLI2cRead, RP2040LLSetupI2C, Rp2040Teardown) {
  ...
  minUnitCheck(i2c_polled_peripheral.read(dummyAddress, receiveData, 0x10000u) == libmcu::Results::kInvalidAddress);
  transmitData[0] = 0x55;
  minUnitCheck(i2c_polled_peripheral.write(expanderAddress, transmitData, 0x10000u) == libmcu::Results::kDone);
  minUnitCheck(i2c_polled_peripheral.read(expanderAddress, receiveData, 0x10000u) == libmcu::Results::kDone);
  minUnitCheck(i2c0Registers->IC_STATUS == 0x06);
