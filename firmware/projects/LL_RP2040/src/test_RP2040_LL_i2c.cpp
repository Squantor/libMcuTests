...
MINUNIT_ADD(RP2040LLI2cSetup, RP2040LLSetupI2C, Rp2040Teardown) {
  minUnitCheck(400000 == i2c_polled_peripheral.Setup(libmcull::i2c::I2cModes::Fast, 400000));
...
MINUNIT_ADD(RP2040LLI2cRead, RP2040LLSetupI2C, Rp2040Teardown) {
  ...
  minUnitCheck(100000 == i2c_polled_peripheral.Setup(libmcull::i2c::I2cModes::Fast, 100000));
