...
MINUNIT_ADD(RP2040gpio, RP2040SetupSio, RP2040Teardown) {
  minUnitCheck(dutRegisters->GPIO[0].STATUS == 0x0000'0000u);
  minUnitCheck(dutRegisters->GPIO[0].CTRL == 0x0000'0005u);
  minUnitCheck(dutRegisters->GPIO[1].STATUS == 0x0000'0000u);
  minUnitCheck(dutRegisters->GPIO[1].CTRL == 0x0000'0005u);
  minUnitCheck(dutRegisters->GPIO[2].STATUS == 0x0000'0000u);
  minUnitCheck(dutRegisters->GPIO[2].CTRL == 0x0000'0005u);
  minUnitCheck(dutRegisters->GPIO[3].STATUS == 0x0000'0000u);
  minUnitCheck(dutRegisters->GPIO[3].CTRL == 0x0000'0005u);
  minUnitCheck(dutRegisters->GPIO[4].STATUS == 0x0000'0000u);
  minUnitCheck(dutRegisters->GPIO[4].CTRL == 0x0000'0005u);
  minUnitCheck(dutRegisters->GPIO[5].STATUS == 0x0000'0000u);
