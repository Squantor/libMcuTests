...
MINUNIT_ADD(LPC845M301DH20GpioPin, LPC845M301SetupGpio, LPC845M301Teardown) {
  ...
  MINUNIT_CHECK(gpio_peripheral.GetState(test_pin_1) != 0u);
  ...
  MINUNIT_CHECK(gpio_peripheral.GetState(test_pin_2) != 0u);
...
MINUNIT_ADD(LPC845M301DH20GpioPort, LPC845M301SetupGpio, LPC845M301Teardown) {
  ...
  MINUNIT_CHECK(gpio_peripheral.GetPortState(test_pin_2_port, test_pin_2.gpioPinMask) == 0x00000000);
  gpio_peripheral.SetPortHigh(test_pin_1_port, test_pin_1.gpioPinMask);
  MINUNIT_CHECK(gpio_peripheral.GetPortState(test_pin_2_port, test_pin_2.gpioPinMask) == test_pin_2.gpioPinMask);
  // switch around pins
  ...
  MINUNIT_CHECK(gpio_peripheral.GetPortState(test_pin_1_port, test_pin_1.gpioPinMask) == test_pin_1.gpioPinMask);
  gpio_peripheral.SetPortLow(test_pin_2_port, test_pin_2.gpioPinMask);
  MINUNIT_CHECK(gpio_peripheral.GetPortState(test_pin_1_port, test_pin_1.gpioPinMask) == 0x00000000);
  // testing the remainder methods
