...
MINUNIT_SETUP(driverMux3to8Setup) {
  ...
  pads_bank0_peripheral.Setup(mux_not_enable_pin, pads::DriveModes::k4mA, pads::PullModes::kNone, false, false);
  gpio_bank0_peripheral.Setup(mux_A0_pin);
  pads_bank0_peripheral.Setup(mux_A0_pin, pads::DriveModes::k4mA, pads::PullModes::kNone, false, false);
  pads_bank0_peripheral.Setup(mux_A1_pin, pads::DriveModes::k4mA, pads::PullModes::kNone, false, false);
  pads_bank0_peripheral.Setup(mux_A2_pin, pads::DriveModes::k4mA, pads::PullModes::kNone, false, false);
  pads_bank0_peripheral.Setup(mux_Y0_pin, pads::DriveModes::k4mA, pads::PullModes::kPullDown, false, true);
  pads_bank0_peripheral.Setup(mux_Y1_pin, pads::DriveModes::k4mA, pads::PullModes::kPullDown, false, true);
  pads_bank0_peripheral.Setup(mux_Y2_pin, pads::DriveModes::k4mA, pads::PullModes::kPullDown, false, true);
  pads_bank0_peripheral.Setup(mux_Y7_pin, pads::DriveModes::k4mA, pads::PullModes::kPullDown, false, true);
